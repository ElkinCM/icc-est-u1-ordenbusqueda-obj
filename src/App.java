...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("\nArray ordenado por código de dirección:");
        viewConsole.printArray(personas);

        Scanner scanner = new Scanner(System.in);
        System.out.print("\nIngrese el código de dirección a buscar: ");
        int codigo = scanner.nextInt();

        Persona busqueda = personaController.findByCodigo(personas, codigo);
        if (busqueda != null) {
            System.out.println("Persona encontrada: " + busqueda);
        } else {
